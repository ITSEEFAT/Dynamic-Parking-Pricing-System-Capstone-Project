...
This file contains the real-time price predictions generated by the Pathway streaming engine for each parking lot based on three different pricing models:
...
Model3Price	Price calculated using the Competitive Pricing model considering nearby lots

💡 Format: JSON Lines (JSONL)
Each line in the file is a valid JSON object. Example:
...
Real-time visualizations (used in Bokeh dashboard)
